...
base {
    archivesName.set("BazaarFlipper")
}
...
loom {
    ...
    launchConfigs {
        getByName("client") {
            ...
            arg("--mixin", "mixins.bazaarflipper.json")
        }
    }
    runConfigs {
        getByName("client") {
    ...
    forge {
        ...
        mixinConfig("mixins.bazaarflipper.json")
    }
    mixin {
        defaultRefmapName.set("mixins.bazaarflipper.refmap.json")
    }
}
        ...
        manifest {
            attributes(
                mapOf(
                    ...
                    "TweakOrder" to "0",
                    "MixinConfigs" to "mixins.bazaarflipper.json",
                )
            )
        }
        dependsOn(shadowJar)
